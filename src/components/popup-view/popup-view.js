        ...
        <Transition isOpened={this.state.isOpened} animationName={animationName} customClass={['van-popup-view']} customStyle={styleObject}>
          <View className='popup-header at-row'>
            ...
            <View className='popup-title'>
              <View className='title van-ellipsis'>{this.props.headerTitle}</View>
              <View className='price'>￥{this.props.headerPrice}
                {
                  this.props.selectedItem.stock && (
                  <View className='stock'>(剩余：{this.props.selectedItem.stock})</View>
                  )
                }
              </View>
            </View>
